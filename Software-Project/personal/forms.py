...
class StudentForm(forms.ModelForm):
    ...
    First_Preference = forms.ChoiceField(label="First Preference", required=False, choices=Student.PROJECTS, widget=forms.Select(attrs={'onchange':'Project1();'}))
    Two_Preference = forms.ChoiceField(label="Second Preference", required=False, choices=Student.PROJECTS, widget=forms.Select(attrs={'onchange':'Project2();'}))
    Three_Preference = forms.ChoiceField(label="Third Preference", required=False, choices=Student.PROJECTS, widget=forms.Select(attrs={'onchange':'Project3();'}))
    Four_Preference = forms.ChoiceField(label="Fourth Preference", required=False, choices=Student.PROJECTS, widget=forms.Select(attrs={'onchange':'Project4();'}))
    Five_Preference = forms.ChoiceField(label="Fifth Preference", required=False, choices=Student.PROJECTS, widget=forms.Select(attrs={'onchange':'Project5();'}))
